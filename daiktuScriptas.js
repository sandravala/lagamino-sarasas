...
const addListItemInput = `<div class=">
 			<input type="text">
				<button type="button" class="plusButton dont-print" style="background-color: #ffffff; color: #1c7f18; border: none;">
   			...
   			<div><button type="button" id="addItem" class="plusButton dont-print" style="background-color: #ffffff; color: #1c7f18; border: none;">Pridėti</button></div>
  `;
