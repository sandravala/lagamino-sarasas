...
window.location.search.includes('print_calculator') ? document.getElementsByClassName('.button.pdf')[0].setAttribute('data-name','12GM-Daiktu-sarasas-atostogoms.pdf') : null;
// jeigu print langas
